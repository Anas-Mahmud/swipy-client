      ...
      <div class="mx-auto max-w-screen-2xl px-4 py-12 sm:px-6 md:py-16 lg:px-8">
        ...
        <div class="mt-8 sm:mt-12">
          <dl class="grid grid-cols-1 gap-4 sm:grid-cols-3">
            <div class="flex flex-col rounded-lg shadow-sm border border-gray-100 hover:border-gray-400 px-4 py-8 text-center">
              <dt class="order-last text-lg font-medium text-gray-500">
                Total Clients
              </dt>

              <dd class="text-4xl font-extrabold text-cyan-600 md:text-5xl">
                $4.8m
              </dd>
            </div>
