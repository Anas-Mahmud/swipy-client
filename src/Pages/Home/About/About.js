            ...
            <section className="dark:bg-gray-800 dark:text-gray-100 mx-5">
                <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
                    <div className="relative w-1/2 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">
                        <img src={service3} alt="" className="w-4/5 border-4 rounded-lg sm:h-80 lg:h-full xl:h-112 2xl:h-128" />
                        <img src={service5} alt="" className="absolute w-3/5 right-6 top-1/2 border-4 rounded-lg sm:h-80 lg:h-full xl:h-112 2xl:h-128" />
                    </div>
                    <div className="flex flex-col justify-center p-6 text-center rounded-sm w-1/2 lg:max-w-md xl:max-w-lg lg:text-left">
                        <p className='text-lg font-semibold text-purple-600 ml-3'>About us</p>
                        <h1 className="text-5xl font-bold leading-none sm:text-6xl">Creative agency that
