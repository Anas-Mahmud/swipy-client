      ...
      <div className="w-5/6 p-4 mx-auto sm:p-10">
        <div className="mb-12 space-y-4 text-center">
          ...
          <p className="px-4 sm:px-8 lg:px-24">
            Feel free to modify or adapt the headline to align with your brand's
            messaging and tone.
          </p>
        </div>
        <div className="grid max-w-md grid-cols-1 gap-6 mx-auto auto-rows-fr lg:grid-cols-3 lg:max-w-full">
            ...
            <div className="flex flex-col items-center justify-center px-2 py-8 dark:bg-gray-900">
              <ul className="self-stretch flex-1 space-y-2">
                ...
                <li className="flex justify-center space-x-2">
                  ...
                  <span>Limited storage capacity</span>
                </li>
                <li className="flex justify-center space-x-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <button className="px-8 py-3 mt-6 text-lg font-semibold rounded sm:mt-12 text-black border border-cyan-500 hover:bg-gradient-to-r from-cyan-500 to-blue-500">
                Sign up
              </button>
            </div>
          </div>
          <div className="flex flex-col overflow-hidden border-2 rounded-md dark:border-violet-400">
            ...
            <div className="flex flex-col items-center justify-center px-2 py-8 dark:bg-gray-900">
              ...
              <button className="px-8 py-3 mt-6 text-lg font-semibold rounded sm:mt-12 text-black bg-gradient-to-r from-cyan-500 to-blue-500">
                Sign up
              </button>
            </div>
          </div>
          <div className="flex flex-col overflow-hidden border-2 rounded-md dark:border-gray-700">
            ...
            <div className="flex flex-col items-center justify-center px-2 py-8 dark:bg-gray-900">
              ...
              <button className="px-8 py-3 mt-6 text-lg font-semibold rounded sm:mt-12 text-black border border-sky-500 hover:bg-gradient-to-r from-cyan-500 to-blue-500">
                Sign up
              </button>
            </div>
          </div>
