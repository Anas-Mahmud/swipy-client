        ...
        <div>
            <section className="my-24">
                <div className="container mx-auto flex flex-col items-center pb-6 mb-4 md:p-10 md:px-12">
                    <h1 className="text-4xl font-semibold leading-none text-center">What customers are saying about this site</h1>
                </div>
                <div className="container mx-auto grid grid-cols-1 gap-8 lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2">
                    <div className="flex flex-col items-center mx-12 lg:mx-0">
                        <div className="relative text-center">
                            ...
                            <p className="px-6 py-1 text-lg italic">Awesome experience working with the team at Swipy! They are always very responsive and continuously gives us suggestions to improve our online presence in the F&B industry. A great help as they managed our SEO and SEM really well and we do not have to worry. Definitely will recommend them!</p>
